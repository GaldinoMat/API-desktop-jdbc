...
public class SellerFormController implements Initializable {
	...
	@FXML
	private ComboBox<Department> comboBoxDept;
	...
	public void onBtSaveAction(ActionEvent event) {
		...
		if (service == null) {
			throw new IllegalStateException("Seller service entity was null");
		}
	...
	private Seller getFormData() {
		...
		obj.setDepartment(comboBoxDept.getValue());
	...
	public void updateFormData() {
		...
		if (entity.getDepartment() == null) {
			comboBoxDept.getSelectionModel().selectFirst();
		} else {
			comboBoxDept.setValue(entity.getDepartment());
		}
	}
	...
	private void initializeComboBoxDepartment() {
		...
		comboBoxDept.setCellFactory(factory);
		comboBoxDept.setButtonCell(factory.call(null));
	}
}
